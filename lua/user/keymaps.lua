...
keymap("v", "<A-j>", "5gj", opts)
keymap("v", "<A-k>", "5gk", opts)
keymap("v", "<A-h>", "5h", opts)
keymap("v", "<A-l>", "5l", opts)
keymap("n", "<A-j>", "5gj", opts) 
keymap("n", "<A-k>", "5gk", opts)
keymap("n", "<A-l>", "5l", opts)
keymap("n", "<A-h>", "5h", opts)
...
keymap("n", "<leader>B", "<cmd>lua require'dap'.set_breakpoint(vim.fn.input '[Condition] > ')<cr>", opts)
...
keymap("n", "<A-n>", "<cmd>lua require'dap'.step_over()<cr>", opts)
keymap("n", "<A-s>", "<cmd>lua require'dap'.step_into()<cr>", opts)
